...
namespace UnityEditor
{
    class StandardShaderGUI : ShaderGUI
    {
        ...
        protected MaterialEditor m_MaterialEditor; //RADIAL
        protected WorkflowMode m_WorkflowMode = WorkflowMode.Specular;//RADIAL
        ...
        protected static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
        {
            ...
            //#LJO : Not sure why detail_mulx2 should trigger when normalmapping? 
            SetKeyword(material, "_DETAIL_MUL", material.GetTexture("_DetailAlbedoMap") || material.GetTexture("_DetailNormalMap"));
